...
test.describe(envDescription + " Case sensitivity", () => {
    ...
    test("GSC: request param is NOT case sensitive", async ({ page }) => {
        ...
        let requestUrl = domain + "/test/geo/pub/wms?=&service=WMS&REQUEST=GetMap&layers=pub:WHSE_HUMAN_CULTURAL_ECONOMIC.EMRG_ORDER_AND_ALERT_AREAS_SP&styles=&format=image/png&transparent=true&version=1.1.0&width=256&height=256&srs=EPSG:4326&tiled=true&bbox=-120.234375,49.921875,-120.05859375,50.09765625";
        let response = await page.goto(requestUrl);
